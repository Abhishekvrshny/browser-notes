...
const App = () => {
    ...
    const handleExport = () => {
        ...
        a.href = url;
        a.download = `jotdown-${new Date().toISOString().split('T')[0]}.json`;
    ...
    const handleDeleteTabRequest = (tabId) => {
        ...
        setConfirmDialog({
            isOpen: true,
            title: 'Delete Note',
            message: `Are you sure you want to delete "${tabToDelete?.title || 'this note'}"? This action cannot be undone.`,
            onConfirm: () => {
