// This file is auto-generated from js/components.js
// Do not edit this file directly - edit the source file instead
// Generated at: 2025-05-27T10:47:09.776Z
...
const ContextMenu = ({
  ...
  }, items.map((item, index) => item.separator ? React.createElement('div', {
    key: index,
...
const Sidebar = ({
  ...
  React.createElement('div', {
    ...
    key: 'info',
    className: 'tab-info'
  }, [editingTab === tab.id ? React.createElement('input', {
    key: 'edit-input',
    type: 'text',
    value: editTitle,
  ...
  }, collapsed ? tab.title.charAt(0).toUpperCase() : tab.title), !collapsed && !editingTab && React.createElement('div', {
    key: 'date',
    className: 'tab-date',
    style: {
      color: 'var(--text-muted)'
    }
  }, new Date(tab.createdAt).toLocaleDateString())]), !collapsed && React.createElement('div', {
    key: 'actions',
...
const Toolbar = ({
  ...
  React.createElement('div', {
    ...
    key: 'text'
  }, getCurrentViewText()), React.createElement('span', {
    key: 'arrow'
  ...
  }, 'Hide Preview'), React.createElement('button', {
    key: 'split-option',
  ...
  }, 'Split View'), React.createElement('button', {
    key: 'full-option',
  ...
  }, 'Full View')])]), React.createElement('button', {
    key: 'theme',
  ...
  }, theme === 'light' ? '🌙 Dark' : '☀️ Light'), React.createElement('div', {
    key: 'font-size',
  ...
  }, `${fontSize}px`), React.createElement('button', {
    key: 'increase',
  ...
  }, 'Ctrl+Shift+P'), React.createElement('span', {
    key: 'word-count',
    className: 'text-sm',
    style: {
      color: 'var(--text-secondary)'
    }
  }, `${wordCount} words`), React.createElement('button', {
    key: 'export',
    onClick: onExport,
    className: 'px-3 py-1 rounded text-sm flex items-center gap-1',
    style: {
